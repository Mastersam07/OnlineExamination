...
<title>CCF NIFES || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">CBT SOFTWARE</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:ccfnifes@yahoo.com" style="color:#000000">abadasamuelosp@gmail.com</a><br /><br />
...
<a href="http://www.ccf-nifes.com/About.html" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Abada Samuel Oghenero" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://abadasamuelosp.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Abada Samuel</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+234 8180690050</h4>
		<h4 style="font-family:'typo' ">abadasamuelosp@gmail.com</h4>
		<h4 style="font-family:'typo' ">Federal university of Technology ,akure</h4></div></div>
		</p>
      </div>
